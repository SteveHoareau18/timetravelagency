  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
<<<<<<< HEAD
      text: "Bienvenue chez TimeTravel Agency. Je suis votre conseiller temporel personnel. Comment puis-je vous assister dans la planification de votre voyage à travers le temps ?",
=======
          ...
          >
            ...
            <div className="bg-gradient-to-r from-amber-500 to-yellow-600 p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
<<<<<<< HEAD
                  <h3 className="font-bold text-slate-900">Conseiller Temporel</h3>
